...
var _scrollAnimationsJs = require("./scrollAnimations.js");
var _scrollAnimationsJsDefault = parcelHelpers.interopDefault(_scrollAnimationsJs);
var _navActiveSectionJs = require("./navActiveSection.js");
var _navActiveSectionJsDefault = parcelHelpers.interopDefault(_navActiveSectionJs);
const setCurrentYear = ()=>{
    const target = document.getElementById('js-current-year');
    if (target) target.textContent = new Date().getFullYear();
};
const init = ()=>{
    (0, _mobileMenuJsDefault.default)();
    (0, _scrollAnimationsJsDefault.default)();
    (0, _navActiveSectionJsDefault.default)();
    setCurrentYear();
};
if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', init);
else init();

},{"../scss/main.scss":"4Pg3x","./mobileMenu.js":"6mDUq","./scrollAnimations.js":"8C4v5","./navActiveSection.js":"4KQIO","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4Pg3x":[function() {},{}],"6mDUq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const closeOnEscape = (event, nav, toggle)=>{
    if (event.key === 'Escape') setNavState(nav, toggle, false);
};
...
const bindMatchMedia = (nav, toggle)=>{
    ...
    const handleChange = (event)=>{
        if (event.matches) setNavState(nav, toggle, false);
    };
...
exports.default = initMobileMenu;
...
},{}],"8C4v5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = initScrollAnimations;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4KQIO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const initFallback = ()=>{
    const onScroll = ()=>{
        ...
        if (current) setActiveLink(current.getAttribute('data-section'));
    };
...
exports.default = initNavActiveSection;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["6DHTQ","6kb64"], "6kb64", "parcelRequire2041", {})
